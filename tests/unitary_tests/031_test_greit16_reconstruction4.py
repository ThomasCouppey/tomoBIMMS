...
im = plt.imshow(np.real(ds_0), interpolation="none", cmap=plt.cm.viridis)
...
# reconstructed
ax1 = plt.subplot(221)
im = ax1.imshow(np.real(ds_5), interpolation="none", cmap=plt.cm.viridis)
ax1.set_title(r"Reconstituted $\Delta Z$ to E-E")
ax1.axis("equal")

# reconstructed
ax2 = plt.subplot(222)
im = ax2.imshow(np.real(ds_9), interpolation="none", cmap=plt.cm.viridis)
ax2.set_title(r"Reconstituted $\Delta Z$ to E-E")
ax2.axis("equal")

ax3 = plt.subplot(223)
im = ax3.imshow(np.real(ds_13), interpolation="none", cmap=plt.cm.viridis)
ax3.set_title(r"Reconstituted $\Delta Z$ to E-S")
ax3.axis("equal")

ax4 = plt.subplot(224)
im = ax4.imshow(np.real(ds_1), interpolation="none", cmap=plt.cm.viridis)
