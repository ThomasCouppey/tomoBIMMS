...
ax1.set_title(r"Reconstituted $\Delta Z$ to E4")
ax1.axis("equal")
...
ax3.set_title(r"Reconstituted $\Delta Z$ to E4")
ax3.axis("equal")

ax4 = plt.subplot(224)
im4 = ax4.tripcolor(pts[:, 0], pts[:, 1], tri, ds_1, vmin=vmin, vmax=vmax)
ax4.set_title(r"Reconstituted $\Delta Z$ to E4")
ax4.axis("equal")
